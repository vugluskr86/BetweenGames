...
const std::vector<ItemProtValue> ItemGenerator::Prototypes = {
	...
	{ WT_WEAPON_2H,ST_RIGHT_HAND,IP_ATTACKPWR,1,20 },
	...
	{ WT_WEAPON_2H,ST_RIGHT_HAND,IP_ATTACKPWR,2,40 },
	...
	{ WT_WEAPON_2H,ST_RIGHT_HAND,IP_ATTACKPWR,3,80 },
	...
	{ WT_WEAPON_2H,ST_RIGHT_HAND,IP_ATTACKPWR,4,160 },
	...
	{ WT_WEAPON_1H,ST_RIGHT_HAND,IP_ATTACKPWR,1,5 },
	...
	{ WT_WEAPON_1H,ST_RIGHT_HAND,IP_ATTACKPWR,2,10 },
	...
	{ WT_WEAPON_1H,ST_RIGHT_HAND,IP_ATTACKPWR,3,15 },
	...
	{ WT_WEAPON_1H,ST_RIGHT_HAND,IP_ATTACKPWR,4,20 },
   ...
   { WT_WEAPON_1H,ST_LEFT_HAND,IP_ATTACKPWR,1,5 },
   ...
   { WT_WEAPON_1H,ST_LEFT_HAND,IP_ATTACKPWR,2,10 },
   ...
   { WT_WEAPON_1H,ST_LEFT_HAND,IP_ATTACKPWR,3,15 },
   ...
   { WT_WEAPON_1H,ST_LEFT_HAND,IP_ATTACKPWR,4,20 },
   ...
   for(auto prot : ItemGenerator::Prototypes) {
      ...
      if(avaliableTypes.size() > 0) {
       //  std::cout << I18n::ITEM_TYPES[prot.type] << std::endl;
         ...
         if(prot.slot == slot && prot.tier == item.tier && itIn != avaliableTypes.end()) {
