...
const std::vector<ItemProtValue> ItemGenerator::Prototypes = {
   { WT_WEAPON_1H,ST_LEFT_HAND,IP_ATTACKPWMULTMAX,0,15 },
   { WT_WEAPON_1H,ST_LEFT_HAND,IP_ELEMDAMAGE_ACID,0,150 },
   { WT_WEAPON_1H,ST_LEFT_HAND,IP_ATTACKPWR,0,400 },
   { WT_WEAPON_1H,ST_LEFT_HAND,IP_HP,0,200 },
   { WT_WEAPON_1H,ST_LEFT_HAND,IP_CRIT,0,30 },
   { WT_WEAPON_1H,ST_LEFT_HAND,IP_ABSORB,0,10 },
   { WT_WEAPON_1H,ST_LEFT_HAND,IP_STUNCHANCE,0,100 },
   { WT_WEAPON_1H,ST_LEFT_HAND,IP_ATTACKPWMULTMAX,1,17 },
   { WT_WEAPON_1H,ST_LEFT_HAND,IP_ELEMDAMAGE_ACID,1,250 },
   { WT_WEAPON_1H,ST_LEFT_HAND,IP_ATTACKPWR,1,800 },
   { WT_WEAPON_1H,ST_LEFT_HAND,IP_HP,1,400 },
   { WT_WEAPON_1H,ST_LEFT_HAND,IP_CRIT,1,50 },
   { WT_WEAPON_1H,ST_LEFT_HAND,IP_ABSORB,1,20 },
   { WT_WEAPON_1H,ST_LEFT_HAND,IP_STUNCHANCE,1,150 },
   { WT_WEAPON_1H,ST_LEFT_HAND,IP_ATTACKPWMULTMAX,2,19 },
   { WT_WEAPON_1H,ST_LEFT_HAND,IP_ELEMDAMAGE_ACID,2,350 },
   { WT_WEAPON_1H,ST_LEFT_HAND,IP_ATTACKPWR,2,1600 },
   { WT_WEAPON_1H,ST_LEFT_HAND,IP_HP,2,800 },
   { WT_WEAPON_1H,ST_LEFT_HAND,IP_CRIT,2,70 },
   { WT_WEAPON_1H,ST_LEFT_HAND,IP_ABSORB,2,30 },
   { WT_WEAPON_1H,ST_LEFT_HAND,IP_STUNCHANCE,2,200 },
   { WT_WEAPON_1H,ST_LEFT_HAND,IP_ATTACKPWMULTMAX,3,21 },
   { WT_WEAPON_1H,ST_LEFT_HAND,IP_ELEMDAMAGE_ACID,3,450 },
   { WT_WEAPON_1H,ST_LEFT_HAND,IP_ATTACKPWR,3,3200 },
   { WT_WEAPON_1H,ST_LEFT_HAND,IP_HP,3,1600 },
   { WT_WEAPON_1H,ST_LEFT_HAND,IP_CRIT,3,90 },
   { WT_WEAPON_1H,ST_LEFT_HAND,IP_ABSORB,3,40 },
   { WT_WEAPON_1H,ST_LEFT_HAND,IP_STUNCHANCE,3,250 }
};
...
/*
      ...
      case WT_WEAPON_2H: {
         addProperties = { IP_ELEMDAMAGE, IP_ATTACKPWR, IP_HP, IP_CRIT, IP_ABSORB };
...
Item ItemGenerator::GenerateTreasueItemByPlayer(uint32_t level)
{
   ...
   int interval[] = { eSlotType::ST_LEFT_HAND };
   double weights[] = { 1 };
