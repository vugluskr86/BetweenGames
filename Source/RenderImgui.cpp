...
namespace BWG {
   namespace Render {
      ...
      struct RenderImGuiImpl {
         ...
         OpenGL::Texture font_texture;
         OpenGL::VertexBuffer vbo, ibo;
      ...
      void RenderImGui::Render(SDL_Window* window, bool reset) {
         ...
         io.DisplayFramebufferScale.x = static_cast<float>(fb_width) / width;
         io.DisplayFramebufferScale.y = static_cast<float>(fb_height) / height;
         ...
         style.Colors[ImGuiCol_TitleBg] = ImColor::HSV(0.0f, 0.5f, 0.5f);
         style.Colors[ImGuiCol_TitleBgActive] = ImColor::HSV(0.0f, 0.7f, 0.5f);
         style.Colors[ImGuiCol_TitleBgCollapsed] = ImColor::HSV(0.0f, 0.3f, 0.5f);
         style.Colors[ImGuiCol_ScrollbarGrab] = ImColor::HSV(0.0f, 0.3f, 0.5f);
         style.Colors[ImGuiCol_ScrollbarGrabHovered] = ImColor::HSV(0.0f, 0.5f, 0.8f);
         style.Colors[ImGuiCol_ScrollbarGrabActive] = ImColor::HSV(0.0f, 0.7f, 0.5f);

         ImGui::Begin("Output", nullptr, ImVec2(static_cast<float>(chat_window_width), static_cast<float>(chat_window_height)), io.WantTextInput ? 1.0f : 0.7f, ImGuiWindowFlags_NoResize | ImGuiWindowFlags_NoSavedSettings | ImGuiWindowFlags_NoMove | ImGuiWindowFlags_NoScrollbar | ImGuiWindowFlags_NoScrollWithMouse | ImGuiWindowFlags_NoCollapse);
         ImGui::BeginChild("output-area", ImVec2(ImGui::GetContentRegionAvailWidth(), static_cast<float>(chat_window_height) - 50), false, 0);
